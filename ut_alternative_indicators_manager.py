"""Summarize alternative-indicator championship results."""
...
REPORT_PATH = Path("reports/ut_alternative_indicators_championship.json")
...
def run() -> None:
    records = [
        ...
        if item["strategy_name"] == "UT Alternative Indicators Championship"
    ]
    ...
    print("UT Alternative Indicators Championship")
